...
\Cref{ch:fundamentals} provides a detailed examination of
...
\Cref{ch:hardware} gives a thorough hardware description of the FMCW MIMO radar system under investigation,
...
\Cref{ch:imaging} shifts the focus to imaging algorithms,
...
\Cref{ch:conclusion} concludes the thesis by presenting the key findings, discussing their implications
