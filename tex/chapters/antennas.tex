...
To explore further, \autoref{fig:chan_amp_tx0} zooms in on one period.
...
\end{figure} \\
\autoref{fig:interference_peak_phase} finally shows the effect of interference on the phase.
